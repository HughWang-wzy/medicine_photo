...
# 加载模型
model = DermoExpert(num_classes=2, pretrained=False, dropout_rate=0.5)
model.load_state_dict(torch.load('./dermoexpert_run/train14/best_model_dermoexpert_training.pth'))
